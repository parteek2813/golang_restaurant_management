...
func CreateInvoice() gin.HandlerFunc {
	return func(c *gin.Context){
		...
		// bind the data into the invoice
		var invoice models.Invoice
		...
		// check if the order exists first and then create the invoice 
		...
		// check for if payment is complete or not 
		status := "PENDING"
		...
		// if the invoice not following the validation criteria of the struct 
